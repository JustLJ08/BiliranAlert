...
class FirstAidGuideScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('First Aid Guide'),// keep AppBar color
      ),
      body: const GradientBackground( // apply the gradient background
        child: FirstAidGuideList(),
      ),
    );
  }
}
...
class FirstAidGuideList extends StatelessWidget {
  const FirstAidGuideList({super.key});
  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> firstAidGuides = [
      // same list as above
      {
        ...
        'image': 'lib/assets/images/cpr.png',
        'steps': '''
